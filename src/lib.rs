...
```ignored
build_dfa_dist1_no_transpose   ... bench:     115,580 ns/iter (+/- 38,866)
build_dfa_dist1_with_transpose ... bench:     112,540 ns/iter (+/- 29,627)
build_dfa_dist2_no_transpose   ... bench:     308,064 ns/iter (+/- 141,326)
build_dfa_dist2_with_transpose ... bench:     301,771 ns/iter (+/- 117,123)
build_dfa_dist3_no_transpose   ... bench:   1,459,171 ns/iter (+/- 267,558)
build_dfa_dist3_with_transpose ... bench:   2,123,324 ns/iter (+/- 1,559,343)
build_dfa_dist4_no_transpose   ... bench:   6,114,126 ns/iter (+/- 654,160)
build_dfa_dist4_with_transpose ... bench:  10,313,151 ns/iter (+/- 1,283,931)
```
